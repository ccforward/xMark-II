<template>
  <aside class="sidebar">
    ...
    <div class="sidebar-item" :class="{ active: currentView === 'uncategorized' }" @click="$emit('navigate', 'uncategorized')">
      <Inbox :size="18" /><span>Uncategorized</span>
    </div>
    ...
    <div
      ...
      @click="$emit('navigate', 'category:' + cat.name)"
    >
    ...
    <div class="sidebar-item" @click="$emit('action', 'manageCategories')">
      <Tag :size="18" /><span>Manage Categories</span>
    </div>
...
<script setup>
import { BookmarkCheck, Inbox, BarChart3, Search as SearchIcon, Library, Plus, Upload, Tag, Settings } from 'lucide-vue-next'
